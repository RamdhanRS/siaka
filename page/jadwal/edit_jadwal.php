<?php $page = "Edit Jadwal Perkuliahan"; ?>
...
<section id="edit-jadwal">
  <div class="row">
    <div class="col-md-12">
      <form class="form-container" action="<?= base_url("/action/jadwal/edit_data.php"); ?>" method="post">
        <div class="form-group">
          ...
          <select name="mata_kuliah" id="mata_kuliah" required>
            ...
            <?php while ($m = mysqli_fetch_array($sql_matakuliah)) { ?>
              <option value="<?= $m["id"]; ?>" <?= $data->id_mk == $m["id"] ? "selected" : "" ?>><?= $m["kode_mk"] . " - " . $m["nama_mk"] . " (" . $m["sks"] . " SKS)" ?></option>
            <?php } ?>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="dosen" id="dosen" required>
            ...
            <?php while ($d = mysqli_fetch_array($sql_dosen)) { ?>
              <option value="<?= $d["id"]; ?>" <?= $data->id_dosen == $d["id"] ? "selected" : "" ?>><?= $d["nidn"] . " - " . $d["nama_lengkap"] ?></option>
            <?php } ?>
          </select>
        </div>
        ...
        <div class="form-group">
          <label>Ruang</label>
          <input type="text" id="ruang" name="ruang" value="<?= $data->ruang ?>" required>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="time" id="jam_mulai" name="jam_mulai" value="<?= $data->jam_mulai ?>" required>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label>Jam Selesai</label>
              <input type="time" id="jam_selesai" name="jam_selesai" value="<?= $data->jam_selesai ?>" required>
            </div>
          </div>
        </div>
